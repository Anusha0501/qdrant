...
- SPLADE (Sparse Lexical and Expansion Model) paper: https://arxiv.org/abs/2109.10086
- Qdrant Query API / Reciprocal Rank Fusion: https://qdrant.tech/documentation/concepts/search/#query-api
- EUR-Lex dataset (Hugging Face): https://huggingface.co/datasets/joelniklaus/eurlex
